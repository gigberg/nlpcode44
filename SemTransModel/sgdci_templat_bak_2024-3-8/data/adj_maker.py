...
def amr_parse(history_sentences, last_reponse, stog=stog):
    ...
    return head_set, tail_set, sent_lenth, w
...
def get_info(dialogue_components_item, domain):
    ...
    head_set, tail_set, sent_lenth, wordlist = amr_parse(history_sentences, last_response)

    return [head_set, tail_set], sent_lenth, wordlist
...
if __name__ == '__main__':
    ...
    for path in file_path:
        ...
        for dialogue_components_item in raw_data:
            ...
            adj, lenth, wordlist  = get_info(dialogue_components_item,domain)


            Data[path][dialogue_components_item['id']] = dict()
            Data[path][dialogue_components_item['id']]['adj'] = adj
            Data[path][dialogue_components_item['id']]['wordlist'] = wordlist
